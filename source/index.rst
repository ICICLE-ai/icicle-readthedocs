...
Software and Cyberinfrastructure - Updated
==============================================
...
.. toctree::
  ...
  HPC Application Runtime Predictor <harp/README.md>
  Intelligent Sparse Library <iSpLib/README.md>

.. toctree::
  :caption: Software Architecture and Design
  :maxdepth: 1

  Base ICICLE Tapis Software <tapis-project/README.rst>
  Event Engine <event-engine/README.md>
  Hello ICICLE Authentication Clients <hello_icicle_auth_clients/README.md>
